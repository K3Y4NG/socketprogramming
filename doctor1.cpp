...
#define MYPORT "41968"	// the port patients would be connecting to.
...
int main(void)
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    cout<<"Phase 3: Doctor 1 has static UDP port "<<(unsigned)(adr_inet1.sin_port)<< " and IP address ";
    cout.flush();
    ...
    while(1){
		...
		cout<<"Phase 3: Doctor 1 receives the request from the patient with port number "<<port_patient<<" and the insurance plan "<<(string)buf1<<".\n";
		...
		if(ins.compare(insu1)==0){
			...
			cout<<"Phase 3: Doctor 1 has sent estimated price "<<(string)token_2c[0][BUFFSIZE]<<"$ to patient with port number "<<port_patient<<".\n";
		}
		if(ins.compare(insu2)==0){
			...
			cout<<"Phase 3: Doctor 1 has sent estimated price "<<(string)token_2c[1][BUFFSIZE]<<"$ to patient with port number "<<port_patient<<".\n";
		}
		if(ins.compare(insu3)==0){
			...
			cout<<"Phase 3: Doctor 1 has sent estimated price "<<(string)token_2c[2][BUFFSIZE]<<"$ to patient with port number "<<port_patient<<".\n";
		}
	}
	close(sockfd);
