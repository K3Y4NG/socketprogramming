...
#define PORT "21968" // the port of the health server the patient connects to.
...
int main(int argc, char *argv[])
{
	...
	hints.ai_family = AF_INET; // // don't care IPv4 or IPv6. use AF_INET for ip4.
    ...
    cout<<"Phase1: The Patient 2 has TCP port number "<<(unsigned)(adr_inet.sin_port)<< " and IP address " << inet_ntoa(adr_inet.sin_addr)<<endl;
	...
	cout<<"Phase1: Authentication request from Patient 2 with username "<<name1<<" and password "<<pass1<<" has been sent to the Health Service Center. \n";
	cout.flush();
	...
	if(auth_received.compare("sucess")==0){
		cout<<"Phase1: Patient 2 authentication result: sucess. \n";
		cout.flush();
	}
	if(auth_received.compare("failure")==0){
		cout<<"Phase1: Patient 2 authentication result: failure. \n";
		cout<<"Phase1: End of Phase 1 for Patient 2. \n";
		close(sockfd);
		exit(1);
	}
	cout<<"Phase1: End of Phase 1 for Patient 2. \n";
	...
	cout<<"Phase 2: The following appointments are available for Patient 2:\n";
	cout.flush();
	cout<<recievedLsit;
	cout.flush();
	...
	int j=0;
 	...
 	// Send the index to the health center.. sigh.. sleepy!!!!!!!!!!!! zzzzzzz
	...
	// If received notavailable the client will close the TCP connection and exit immediately.
	if(receiveddoc.compare("notavailable")==0){
		cout<<"Phase 2: The requested appointment from Patient 2 is not available. Exiting ....";
		close(sockfd);
		exit(1);
	}
	...
	cout<<"Phase 2: The requested appointment is available and reserved to Patient 2. The assigned doctor port number is "<<port_number_doc<<".\n";

	////////////////////////////// Phase 3 ///////////////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////Read from file patient2insurance.txt ///////////////////

	 USERS=1;
	 BUFFSIZE=30; 
	FILE *fp1;
	char *lines1[USERS][BUFFSIZE];
	fp1=fopen("patient2insurance.txt","r");
	 if(fp1 == NULL) {
 	  perror("Error opening file");
   	  return(-1);
 	}
	...
	//cout<<insurance<<"\n";
	/////////////////////////////////////////////////////finished reading patient2insurance.txt ////////////////////////////////////////////////
    ...
    //printf("%s: %u \n", inet_ntoa(adr_inet1.sin_addr), (unsigned)(adr_inet1.sin_port));    
    cout<<"Phase 3: The Patient 2 has dynamic UDP port number "<<(unsigned)(adr_inet1.sin_port)<< " and IP address " << s<<".\n";
    cout.flush();
	...
	cout<<"Phase 3: The cost estimation request from Patient 2 with insurance plan "<<insurance<<" has been sent to the doctor with port number "<<port_number_doc<< " and IP address "<<s<<".\n";
	...
	cout<<"Phase 3: Patient 2 receives "<<(string)buf2<<"$ estimation cost from docor with port number "<<port_number_doc<< " and IP address "<<s<<".\n";
	cout<<"Phase 3: End of Phase 3 for Patient 2.\n";
